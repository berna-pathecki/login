        ...
        <section class="row mt-3 ">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaRegistro">
                ...
                <form action="#" method="post" class="p-2" id="formRegistro">
                    ...
                    <div class="form-group">
                        <input type="text" name="nomeUsuario" id="nomeUsuario" class="form-control" placeholder="Nome do Usuário" required minlength="5">
                    </div>
                    ...
                    <div class="form-group">
                        <input type="password" name="senhaUsuarioConfimar" id="senhaUsuarioConfimar" class="form-control" placeholder="Confimar Senha" required minlength="8">
                    </div>
